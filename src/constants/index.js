export const myProjects = [
  ...
  },
  {
    ...
    title: "Spotify Clone",
    description:
      "A responsive web application that mimics the core features of the Spotify music streaming service.",
    subDescription: [
      "Developed a modern UI using React and Tailwind CSS for a seamless user experience.",
      "Integrated the Spotify Web API to fetch and display music data in real-time.",
      "Implemented core functionalities such as playlist creation, song playback, and user authentication.",
    ],
    href: "https://spotify-clo1.netlify.app/",
    logo: "",

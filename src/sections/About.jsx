  ...
  return (
    ...
    md:auto-rows-[18rem] mt-12"
      >
        {/* grid 1 */}
        <div
          className="flex items-end grid-default-color
       grid-1"
        >
          <img
            ...
            alt=""
            className="absolute
          scale-[1.75] -right-[5rem] -top-[1rem] md:scale-[3] md:left-50 md:inset-y-10 lg:scale-[2.5]"
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Pushparajah Dilukshan</p>
            <p className="subtext">
              Over the last2 years, I developed my frontend and packend
        ...
        <div className="grid-default-color grid-2">
          <div className="flex items-center justify-center w-full h-full">
            ...
            <Card style={{rotate:"90deg", bottom:"30%", left:"70%"}} text="Design Priciples"/>
